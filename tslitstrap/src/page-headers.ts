...
@localized()
@customElement("page-headers")
export class PageHeaders extends BootBase {
    static styles = [...BootBase.styles, css`
        .bd-placeholder-img {
            font-size: 1.125rem;
            text-anchor: middle;
  ...
  <div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
        ...
        <span class="fs-4">${msg(`Simple header CLICK HOME to Navigate Back`)}</span>
      </a>

      <ul class="nav nav-pills">
        <li class="nav-item"><a href="#" class="nav-link active" aria-current="page"
            @click=${():void=>{appStore.setPage("People")}}>${msg("Home",{desc:"Home button",id:"home-button"})}</a></li>
...
declare global { interface HTMLElementTagNameMap { "page-headers": PageHeaders}}
